...
Later Straube et al. (2013) using the same system, analyzed the theoretical and experimental behavior of the particles for increasing frequencies, observing two different phases, a locked phase and a sliding one \cite{straube2013synchronous}.
