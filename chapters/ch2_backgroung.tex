...
\begin{figure}
  ...
  \end{center}
  \caption[Artificail microswimmers]{\textbf{Panel 1)} shows the configuration of nanorods of Gold (Au) and Platinum (Pt), obtained from \cite{paxton2004catalytic}. \textbf{3} shows a chain of red blood cells linked with superparamagnetic filaments, obtained from \cite{dreyfus2005microscopic}.}\label{fig:artificialexamples}
\end{figure}
