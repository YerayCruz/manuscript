...
\begin{figure}[h]
  ...
  \end{center}
  \caption[Ratchet potential examples.]{Example of ratchet potentials reconstructed from~\cite{kanada1999thermal}. \textbf{Panel a) and b)} show asymmetric potentials, the remaining are symetric. }\label{fig:ratchetpotential} %%% Paper thermal ratchets with symmetric potentials
\end{figure}
